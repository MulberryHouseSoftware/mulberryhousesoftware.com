...
export default function Infographics() {
  return (
    <>
      <Head>
        <title>Infographics - Mulberry House Software</title>
        <meta
          name="description"
          content="Some of the infographics and videos we've created."
        />
      </Head>
      <SimpleLayout
        title="Some of the infographics and videos we've created."
        intro="One of our favorite ways to share our ideas is through posters and videos."
      >
